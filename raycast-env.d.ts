...
type ExtensionPreferences = {
  ...
  /** Experimental features - Enable the search pattern dropdown in the search command. */
...
declare namespace Preferences {
  ...
  /** Preferences accessible in the `findNotebooksDotCom` command */
  export type FindNotebooksDotCom = ExtensionPreferences & {}
...
declare namespace Arguments {
  ...
  /** Arguments passed to the `findNotebooksDotCom` command */
  export type FindNotebooksDotCom = {}
